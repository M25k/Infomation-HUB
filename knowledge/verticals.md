...
Öffentliche Quelle: [northdocks.com](https://northdocks.com/) Abschnitt OUR VERTICALS, Stand 2026-08-26.

**Kanonisch (Entscheidung 2026-08-26): sieben öffentliche Vertikale** wie auf northdocks.com. Das Business Deck JP („five Verticals“) ist veraltet und hat keinen Quellenrang für Anträge.

## Öffentliche Vertikale
...
| 6 | Meta-dom | Kölner Dom in VR | https://meta-dom.de/ | meta-dom.de |
| 7 | GodView | Kommandozentrale, Digital Twins, Datenintegration | https://godview.solutions/ | godview.solutions |
...
Produktplattform für Feuerwehr, Werkfeuerwehr, Brandschutz, Jugendfeuerwehr, Recruiting. All-in-one Koffer, Kauf/Miete, kein laufendes Software-Abo im öffentlichen Preismodell.
...
XR-Stadttouren mit amatik. Öffentliche Projekte: Zeitreise Landeshaven (SH-Landtag), Havenspuren Wilhelmshaven, Treverer Code Trier, Meta-dom Köln.

Site: 5+ Touren, 50.000+ Besucher. Deck: 3+ Städte, 100+ Headsets. Eye-Tracking/Blicksteuerung ist die Eignungsschiene für UKSH.

## 6. Meta-dom

Digital Twin Kölner Dom für VR/Mobile (Coming Soon auf Pico, iOS, Android). Photogrammetrie, Unreal Engine 5, Unterstützung ZDV.

Zitierfähig (Entscheidung 2026-08-26): **100.000+ Fotos und 1.000 Laserscans**. News 2020 (30.000 Fotos) nicht mehr verwenden. Polygonzahl öffentlich: two-billion / 2B+.

## 7. GodView — zwei Kundentypen (Entscheidung 2026-08-26)

Eine Plattform, **zwei Nutzungen**. In Anträgen immer zuerst den Kundentyp nennen, sonst klingt es nach zwei Produkten.

| Kundentyp | Typischer Nutzer | Was GodView leistet | Referenzbild |
|---|---|---|---|
| **A — Bauinspektion / Bestand** | Dombaumeister, Bauleitung, Facility, Vermessung | Photogrammetrie, Punktwolken, Messung, Risse/Schäden, Dokumentation | Kölner Dom / ZDV |
...
**Nicht vermischen:** GodView (Browser) ist nicht die Unreal-Trainingsanwendung auf dem Headset. Headset = Training/Avatar; GodView = Twin + Leitung/Inspektion. UKSH: GodView darf als Einsatzleiter-Sicht weiterentwickelt werden, ist aber nicht die VR-App der Einsatzkräfte.

## Querschnitt (kein Vertical, aber für Anträge zentral)

- **NDFramework**: Unreal-5.7-Trainingsframework (OpenXR, Pico, Multiplayer/Advanced Sessions).
- **ND-Processing**: Photogrammetrie-Pipeline RealityCapture → 3D Tiles.
- **White Label / Launcher / XR Viewer**: interne Plattformprojekte in Asana.
