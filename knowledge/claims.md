...
Nur diese Zahlen/Sätze in Dokumente. Stufe: öffentlich | intern | widersprüchlich | nicht verwenden.
...
| Reschke Productions GmbH (FA-Rechnungen, intern ca. 137 k€) als Kunde, Referenz oder Eignung | **nicht verwenden** | GF 30.08.2026: **interne Verrechnungen**, kein externer Auftraggeber |
...
| Umsatz VR/Simulation > 200.000 € netto in mind. einem der letzten drei GJ | intern | UKSH-Eignung 2026. FreeAgent-Verkauf 2023–25 jeweils darüber ([accounting.md](accounting.md)). FA **ohne** Fördermittel |
...
| rund 400 internationale Kundenorganisationen | **nicht verwenden** intern/Eignung | EIC-Pitch-Mail an IB.SH 17.07.2026. C-Level darf außen gelegentlich übertreiben; KB und Angebote bleiben bei **>100** |
| 23 Trainingsmodule (Stand 2026; Zahl steigt periodisch) | öffentlich | firefightervr.de `trainingslist.html`. Didaktik v47 (22) nicht als Zähler |
...
| Trusted by Currenta CHEMPARK, RWE, Framatome | öffentlich (Site) | nextfactoryvr.com Security. Intern: RWE/Framatome = FFVR-Feuerlöscher; Framatome Lieferantenanlage 09/2024. RWE-Mail 03/2021 nur Probeanmeldung (Udo Moll, Werkfeuer RWE Power), **keine** PO. Factory-Randfall z. B. Sprinklerwartung, kein Twin-Vollprojekt |
...
- „Produktionsengine der Trainingsanwendungen: Unreal Engine 5 mit OpenXR. GodView ist die browserbasierte Twin-Plattform mit zwei Kundentypen: Bauinspektion (z. B. Kölner Dom) und Einsatzleitung (z. B. Feuerwehr, analog Planspiel/Playground). GodView ist nicht die Headset-Trainingsanwendung.“
- „Der Digital Twin des Kölner Doms basiert auf mehr als 100.000 Fotos und 1.000 Laserscans.“
