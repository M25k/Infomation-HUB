...
|---|---|---|---|
| Merck Technikum | Merck KGaA | Laserscan-Pilotanlage, Technikertraining, 72h-Retention-Studie auf Website | archiviert Asana, öffentlich als Case |
| Actemium Infinity / ACHEMA Arena | Actemium / VINCI Energies | Hazard-Training, Förderband, 1. Hilfe-Erweiterung | teilweise archiviert |
| Currenta Technikum Explorer | Currenta | Explorer auf Twin | öffentlich Case |
| Sprinkler Bayer/Henkel | Bayer / Henkel | Sprinklerwartung | öffentlich Case |
| Omexom Freileitungsbau | Omexom | archiviert | archiviert |
| AC Mechatronic | Actemium-Umfeld | archiviert | archiviert |
| 1Komma5 Showroom | 1Komma5 | Showroom VR | Auftrag |
| Sonnen | Sonnen | Videos / Projekt | archiviert |
| Philips Sound | Philips | Sound | Auftrag |
...
FirefighterVR-Inhaltsprojekte (Auswahl): Firefighting, Waldbrand (archiviert), Feuerlöscher, Unfallsicherung, Erkundung, Löschangriff, Flashover 2025, First Aid 2025, CPR 2024, Drehleiter, Notfallpneumatik, Ladungssicherung, Turbolöscher, Firesaber, Brandbekämpfung Schlafzimmer, PKW-Rettung, AED, Sprungkissen (archiviert).
